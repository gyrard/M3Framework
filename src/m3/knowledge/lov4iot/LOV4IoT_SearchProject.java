 ...
 */
public class LOV4IoT_SearchProject {
	/**
	...
	public LOV4IoT_SearchProject(String swot_dataset, String m3_onto, String sparql_query, String stac_dataset, String stac_onto) {
		super();
