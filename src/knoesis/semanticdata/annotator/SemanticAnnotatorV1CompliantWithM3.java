 ...
 */
public class SemanticAnnotatorV1CompliantWithM3 {
	...
	public SemanticAnnotatorV1CompliantWithM3() {
	...
	public Resource createMeasurementInstance(Model model, String measurementURI, Measurement element, String baseName) throws IOException{
		Property hasName = ResourceFactory.createProperty(old_VariablesFileLocation.NAMESPACE_M3, "hasName"); 
		Property hasValue = ResourceFactory.createProperty(old_VariablesFileLocation.NAMESPACE_M3, "hasValue"); 
		Property hasTime = ResourceFactory.createProperty(old_VariablesFileLocation.NAMESPACE_M3, "hasDateTimeValue"); 
		Property hasUnit = ResourceFactory.createProperty(old_VariablesFileLocation.NAMESPACE_M3, "hasUnit");

		Resource resource = model.createResource(measurementURI);
		resource.addProperty(RDF.type, model.getResource(old_VariablesFileLocation.NAMESPACE_M3 + "Measurement"));
